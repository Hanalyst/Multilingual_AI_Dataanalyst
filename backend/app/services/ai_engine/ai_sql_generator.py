...
def generate_sql_with_ai(
    ...
    system_prompt = (
        ...
        "4. For date grouping use DATE_TRUNC('month', \"column\") for monthly (PostgreSQL syntax)\n"
        ...
        "9. Column aliases must be in English only (e.g. AS total_sales, AS category)\n"
        "10. For 'last month' use DATE_TRUNC('month', \"date_col\") = DATE_TRUNC('month', NOW() - INTERVAL '1 month')\n"
        "11. For 'this month' use DATE_TRUNC('month', \"date_col\") = DATE_TRUNC('month', NOW())\n"
